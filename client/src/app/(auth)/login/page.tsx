    ...
    <div className={`min-h-screen flex ${isDark ? 'bg-[#050505]' : 'bg-[#fafafa]'}`}>
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden bg-black text-white flex-col justify-between p-12 border-r border-white/10">
        ...
        <div className="relative z-20 max-w-lg">
          ...
          >
            Institutional-Grade Algorithmic Sandbox.
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Deploy, backtest, and secure quantitative models against adversarial machine learning threats in real-time.
          </motion.p>
        </div>
      ...
      {/* ─── RIGHT: AUTH FORM ─────────────────────────────────────────────────── */}
      <div className="flex-1 flex flex-col relative justify-center items-center p-6 sm:p-12">
        {/* Back to Home Mobile */}
        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
            ...
            <div className="flex justify-end mt-1">
              <NextLink href="/forgot-password" className={`text-sm font-semibold transition-colors ${isDark ? 'text-zinc-400 hover:text-white' : 'text-zinc-500 hover:text-black'}`}>
                Forgot password?
              </NextLink>
            </div>
          ...
          <div className="mt-10 text-center">
            <p className={`text-sm ${isDark ? 'text-zinc-400' : 'text-zinc-500'}`}>
              ...
              <NextLink href="/register" className={`font-bold transition-colors ${isDark ? 'text-white hover:text-zinc-300' : 'text-black hover:text-zinc-700'}`}>
                Create an account
              </NextLink>
            </p>
          </div>
